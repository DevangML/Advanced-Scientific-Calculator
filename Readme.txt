This is the list of all functions and variables done so far :
...
Program Size : 2241 Lines

Note: Total of 8 functions/programs have been removed due to multiple reasons.
      This is semi-final list.
      In final list more functions may be included and the code will be polished even more.
